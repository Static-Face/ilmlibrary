document.addEventListener("DOMContentLoaded", function () {
    const duas = [
        { arabic: 'أَعُوذُ بِاللَّهِ وَقُدْرَتِهِ مِنْ شَرِّ مَا أَجِدُ وَأُحَاذِرُ', translation: 'I seek refuge with Allah and with His Power from the evil that I find and that I fear', source: 'Sahih Muslim 2202' },
        { arabic: 'رَبَّنَا تَقَبَّلْ مِنَّآ ۖ إِنَّكَ أَنتَ ٱلسَّمِيعُ ٱلْعَلِيمُ', translation: 'Our Lord! Accept ˹this˺ from us. You are indeed the All-Hearing, All-Knowing', source: 'Surah Al-Baqarah 2:127' },
        { arabic: 'يَقُولُ رَبَّنَآ ءَاتِنَا فِى ٱلدُّنْيَا حَسَنَةًۭ وَفِى ٱلْـَٔاخِرَةِ حَسَنَةًۭ وَقِنَا عَذَابَ ٱلنَّارِ', translation: 'Our Lord! Grant us the good of this world and the Hereafter, and protect us from the torment of the Fire', source: 'Surah Al-Baqarah 2:201' },
        { arabic: 'رَبَّنَآ أَفْرِغْ عَلَيْنَا صَبْرًۭا وَتَوَفَّنَا مُسْلِمِينَ', translation: 'Our Lord! Shower us with perseverance, and let us die while submitting ˹to You˺', source: 'Surah Al-A\'raf 7:126' },
        { arabic: 'رَبَّنَا ٱغْفِرْ لِى وَلِوَٰلِدَىَّ وَلِلْمُؤْمِنِينَ يَوْمَ يَقُومُ ٱلْحِسَابُ', translation: 'Our Lord! Forgive me, my parents, and the believers on the Day when the judgment will come to pass', source: 'Surah Ibrahim 14:41' },
        { arabic: 'قَالَ رَبِّ ٱشْرَحْ لِى صَدْرِى * وَيَسِّرْ لِىٓ أَمْرِى', translation: 'My Lord! Uplift my heart for me, and make my task easy', source: 'Surah Taha 20:25-26' },
        { arabic: 'رَّبِّ زِدْنِى عِلْمًۭا', translation: 'My Lord, increase me in knowledge', source: 'Surah Taha 20:114' },
